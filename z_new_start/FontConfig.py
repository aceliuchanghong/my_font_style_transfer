new_start_config = {
    ...
    # },
    'dev': {
        'z_coordinate_pkl_path': '/data/llch/files/font_coor_test',
        'z_pic_pkl_path': '/data/llch/files/font_pics_pkl_test',
        'content_pkl_path': '/data/llch/files/new_chinese_content.pkl',
        'character_pkl_path': '/data/llch/files/new_character_dict.pkl',
        'coors_pkl_path': '/data/llch/files/LXGWWenKaiGB-Light.pkl',
        'save_model_dir': '/data/llch/my_font_style_transfer/z_new_start/save_model',
        'PER_BATCH': 64,
        'NUM_THREADS': 8,
    },
    'train': {
